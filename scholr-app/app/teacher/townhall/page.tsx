...
export default async function TeacherTownHallPage() {
  ...
  return (
    <div className="p-6 pb-24 md:pb-6 max-w-3xl mx-auto">
      <div className="mb-6 pt-2">
        ...
        <p className="text-sm mt-1" style={{ color: "var(--c-text-muted)" }}>School-wide announcements from your administrators.</p>
      </div>
