...
To exercise any of these rights, email hello@scholr.app with the subject "Data Request". We will respond within 30 days.`,
  },
  {
    ...
    <div style={{ background: "var(--c-bg)", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 740, margin: "0 auto", padding: "60px 24px 80px" }}>
        ...
        <div className="mt-16 pt-8 flex flex-wrap gap-4 text-sm" style={{ borderTop: "1px solid var(--c-border)" }}>
          <Link href="/terms" style={{ color: "var(--c-indigo)", textDecoration: "none", fontWeight: 600 }}>
            Terms of Service →
          </Link>
          <a href="mailto:privacy@scholr.app" style={{ color: "var(--c-text-muted)", textDecoration: "none" }}>
            privacy@scholr.app
          </a>
        </div>
      </div>
